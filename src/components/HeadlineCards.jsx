...
const HeadlineCards = () => {
  return (
    <div>
    <h1 className='text-primary font-bold text-4xl text-center dark:bg-slate-600 dark:text-white'>
New Menu
  </h1>

    <div className=' dark:bg-slate-600 dark:text-white max-w-[1640px] mx-auto p-4 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols- lg:grid-cols-4 gap-6'>
