...
const Food = () => {
  ...
  return (
    <div className='max-w-[1640px] m-auto px-4 py-12 dark:bg-slate-600 dark:text-white'>
      ...
      <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4 '>
        {foods.map((item, index) => (
          <div
            key={index}
            className='dark:bg-slate-800 dark:text-white border shadow-lg rounded-lg hover:scale-105 duration-300'
          >
            <img
              src={item.image}
              alt={item.name}
